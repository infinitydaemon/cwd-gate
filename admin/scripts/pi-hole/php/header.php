...
*  CWD SYSTEMS uses its branded version of Pi-Hole for Gate appliance
*  and provides warranty againts hardware defects only.
...
<head>
    ...
    <title>CWD<?php echo $hostname ? ' - '.$hostname : ''; ?></title>
