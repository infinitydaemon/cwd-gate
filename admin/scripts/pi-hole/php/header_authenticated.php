...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><strong>0KN Gate</strong></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <a class="btn-link" href="https://cwd.systems/" rel="noopener" target="_blank">CWD Website</a>
                                <hr>
                                <a class="btn-link" href="https://docs.pi-hole.net/" rel="noopener" target="_blank">Documentation</a>
                                <a class="btn-link" href="https://discourse.pi-hole.net/" rel="noopener" target="_blank">Pi-hole Forum</a>
                                <a class="btn-link" href="https://github.com/infinitydaemon/cwd-gate" rel="noopener" target="_blank">GitHub</a>
                                <?php if (strlen($pwhash) > 0) {  // Show "Logout" link only when the user has the password protection enabled.?>
                                <hr>
                                <a class="btn-link" href="logout.php" rel="noopener">Log out</a>
                                <?php } ?>
                            </li>
                        </ul>
                    </li>
